...
### [`r icon::fa("link")`](https://dplyr-wisely.netlify.app) [dplyr-wisely.netlify.app](https://dplyr-wisely.netlify.app)
...
Fill in the code blanks below to find the maximum value of all body dimensions (including body mass) for each combination of species and island using `across()`. Specify a `.names` argument so that each output column name ends with the suffix "_max".
